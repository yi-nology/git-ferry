...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'mirror', name: 'MirrorChannels', component: () => import('@/views/mirror/MirrorChannelList.vue'), meta: { title: '镜像中心' } },
      { path: 'mirror/:id', name: 'MirrorChannelDetail', component: () => import('@/views/mirror/MirrorChannelDetail.vue'), meta: { title: '镜像通道' } },
